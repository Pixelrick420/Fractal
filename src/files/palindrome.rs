...
fn main() {
    ...
    let mut fractal_s: [char; 11] = ['a', 'b', 'c', 'd', 'e', 'f', 'e', 'd', 'c', 'b', 'a'];
    __fractal_debug_snapshot!("Decl s : :array =", "<main>", 0, [__fractal_debug_var("fractal_s", ":array", &{ let __v = &fractal_s; format!("{:?}", __v) })], false, None::<&str>);
    let mut fractal_j: i64 = 10_i64;
    __fractal_debug_snapshot!("Decl j : :int =", "<main>", 0, [__fractal_debug_var("fractal_s", ":array", &{ let __v = &fractal_s; format!("{:?}", __v) }), __fractal_debug_var("fractal_j", ":int", &{ let __v = &fractal_j; format!("{:?}", __v) })], false, None::<&str>);
    {
        let mut fractal_i: i64 = 0_i64;
        while fractal_i < 11_i64 {
            __fractal_debug_snapshot!("For i", "<main>", 0, [__fractal_debug_var("fractal_s", ":array", &{ let __v = &fractal_s; format!("{:?}", __v) }), __fractal_debug_var("fractal_j", ":int", &{ let __v = &fractal_j; format!("{:?}", __v) })], false, None::<&str>);
            if (fractal_s[fractal_i as usize] != fractal_s[fractal_j as usize]) {
                { print!("not palindrome"); io::stdout().flush().unwrap(); };
                break;
            }
            fractal_j -= 1_i64;
            __fractal_debug_snapshot!("Assign MinusEq", "<main>", 0, [__fractal_debug_var("fractal_s", ":array", &{ let __v = &fractal_s; format!("{:?}", __v) }), __fractal_debug_var("fractal_j", ":int", &{ let __v = &fractal_j; format!("{:?}", __v) })], false, None::<&str>);
            fractal_i += 1_i64;
        }
    }
    __fractal_debug_snapshot!("For i", "<main>", 0, [__fractal_debug_var("fractal_s", ":array", &{ let __v = &fractal_s; format!("{:?}", __v) }), __fractal_debug_var("fractal_j", ":int", &{ let __v = &fractal_j; format!("{:?}", __v) })], false, None::<&str>);
    __fractal_debug_snapshot!("If", "<main>", 0, [__fractal_debug_var("fractal_s", ":array", &{ let __v = &fractal_s; format!("{:?}", __v) }), __fractal_debug_var("fractal_j", ":int", &{ let __v = &fractal_j; format!("{:?}", __v) })], false, None::<&str>);
    if (fractal_j == (-1_i64)) {
        { print!("\nPalindrome\n"); io::stdout().flush().unwrap(); };
        __fractal_debug_snapshot!("ExprStmt", "<main>", 0, [__fractal_debug_var("fractal_s", ":array", &{ let __v = &fractal_s; format!("{:?}", __v) }), __fractal_debug_var("fractal_j", ":int", &{ let __v = &fractal_j; format!("{:?}", __v) })], false, None::<&str>);
    } else {
        { print!("\nnot palindrome\n"); io::stdout().flush().unwrap(); };
        __fractal_debug_snapshot!("ExprStmt", "<main>", 0, [__fractal_debug_var("fractal_s", ":array", &{ let __v = &fractal_s; format!("{:?}", __v) }), __fractal_debug_var("fractal_j", ":int", &{ let __v = &fractal_j; format!("{:?}", __v) })], false, None::<&str>);
    }
    __fractal_debug_snapshot!("Program finished", "<main>", 0, [__fractal_debug_var("fractal_s", ":array", &{ let __v = &fractal_s; format!("{:?}", __v) }), __fractal_debug_var("fractal_j", ":int", &{ let __v = &fractal_j; format!("{:?}", __v) })], true, None::<&str>);
}
